...
const transactionTypePolicies: Record<TransactionType, TransactionTypePolicy> = {
  ...
  settlement_carryover: { adminOnly: false },
  settlement_carryover_apply: { adminOnly: false },
  withdrawal_reserve: { adminOnly: false },
  withdrawal_finalized: { adminOnly: false },
  withdrawal_provider_failure_release: { adminOnly: false },
